...
\begin{enumerate}
  ...
  \item \(9 - \big( -(3 - 7) - (-5 + 13) \big) = 9 - \big( -(-4) - 8 \big) = 9 - (4 - 8) = 9 - (-4) = 9 + 4 = \mathbf{13}\) % 5.
  ...
  \item \(3 - \Big( 4 - \big( 5 - (-7 + 8) \big) \Big) = 3 - \big( 4 - (5 - 1) \big) = 3 - (4 - 4) = 3 - 0 = \mathbf{3}\) % 10.

  \item \((-8 + 15) - \big( 5 - (6 - 18) \big) = 7 - \big( 5 - (-12) \big) = 7 - (5 + 12) = 7 - 17 = \mathbf{-10}\) % 11.

  \item \(- \big( (-4 - 9) - (12 - 7) \big) = -(-13 - 5) = -(-18) = \mathbf{18}\) % 12.

  \item \(6 - \big( (8 - 5) - 3 \big) = 6 - (3 - 3) = 6 - 0 = \mathbf{6}\) % 13.

  \item \(1 + \Big( \big( -(4 - 7) + 3 \big) - \big( -1 - 2 \big) \Big) = 1 + \Big( \big( -(-3) + 3 \big) - \big( -1 - 2 \big) \Big) = 1 + \big( (3 + 3) - (-3) \big) =
    1 + (6 + 3) = 1 + 9 = \mathbf{10}\) % 14.
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \(2^{93} \cdot 2^{27} \cdot 2^{-42} \cdot 2^{-69} = 2^{93 + 27 - 42 - 69} =
    2^{120 - 111} = 2^9 = 2^5 \cdot 2^4 = 32 \cdot 16 = 64 \cdot 8 = 128 \cdot 4 = 256 \cdot 2 = \mathbf{512}\) % i)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \(5a - \Big( \big( -3b + 2a \big) - \big(7a + (-9b) \big) \Big) = 5a - \big( -3b + 2a - 7a - (-9b) \big) = 5a - (6b - 5a) =
    5a - 6b + 5a = \mathbf{10a - 6b}\) % i)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \(-3y - 4x - (2y - x + 3y) = -3y - 4x - (5y - x) = -3y - 4x - 5y + x = (-4 + 1)x + (-3 - 5)y = \mathbf{-3x - 8y}\) % d)
  ...
  \item \(\big( 2 - (u - 3v) + 5u \big) - \big( 3v + 1 - (-2v + 3u) \big) = (2 - u + 3v + 5u) - (3v + 1 + 2v - 3u) =
    (2 + 4u + 3v) - (5v + 1 - 3u) = 2 + 4u + 3v - 5v - 1 + 3u = (4 + 3)u + (3 - 5)v + 1 = \mathbf{7u - 2v + 1}\) % h)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \((3x - 6y + 2z) \cdot (5x + 3y) = 15x^2 + 9xy - 30xy - 18y^2 + 10xz + 6yz = \mathbf{15x^2 - 21xy + 10xz - 18y^2 + 6yz}\) % m)

  \item \((a - 2b + 3c) \cdot (a - 2b + 3c) = a^2 - 4ab + 6ac + 4b^2 - 12bc + 9c^2 = \mathbf{a^2 - 4ab + 6ac + 4b^2 - 12bc + 9c^2}\) % n)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \((x^2 - 1) \cdot (1 + x + x^2 + x^3) = x^2 + x^3 + x^4 + x^5 - 1 - x - x^2 - x^3 = \mathbf{x^5 + x^4 - x - 1}\) % j)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \((x - 1) \cdot (x + 2) + (x + 3) \cdot (x + 1) = x^2 + x - 2 + x^2 + 4x + 3 = \mathbf{2x^2 + 5x + 1}\) % b)

  \item \({(x + 5)}^2 + 3 \cdot (2x + 3) = x^2 + 10x + 25 + 6x + 9 = \mathbf{x^2 + 16x + 34}\) % c)

  \item \(2 \cdot (x + 5) \cdot (x + 3) - (x - 7) \cdot (2x + 1) = 2 \cdot (x^2 + 8x + 15) - (2x^2 + x - 14x - 7) =
  2x^2 + 16x + 30 - (2x^2 - 13x - 7) = 2x^2 + 16x + 30 - 2x^2 + 13x + 7 = \mathbf{29x + 37}\) % d)

  \item \({(2x + y)}^2 - {(x - 3y)}^2 = 4x^2 + 4xy + y^2 - (x^2 - 6xy + 9y^2) = 4x^2 + 4xy + y^2 - x^2 + 6xy - 9y^2 =
  \mathbf{3x^2 + 10xy - 8y^2}\) % e)

  \item \((2a - 3b) \cdot (3a + b) - 2 \cdot (3a + b) \cdot (a - b) = 6a^2 + 2ab - 9ab - 3b^2 - 2 \cdot (3a^2 - 3ab + ab - b^2) =
  6a^2 - 7ab - 3b^2 - 2 \cdot (3a^2 - 2ab - b^2) = 6a^2 - 7ab - 3b^2 - 6a^2 + 4ab + 2b^2 = \mathbf{-3ab - b^2}\) % f)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \({(2x + 1)}^2 - {(3x - 2)}^2 + 3 \cdot {(x + 5)}^2 = 4x^2 + 4x + 1 - (9x^2 - 12x + 4) + 3 \cdot (x^2 + 10x + 25) =
  ...
  \item \({(x + 7)}^2 + {(x - 7)}^2 + 2 \cdot (x - 7) \cdot (x + 7) =
    ...
    \item \({(x^2 + 3)}^2 - {(x^2 - 2)}^2 + 4 \cdot {(x + 3)}^2 = x^4 + 6x^2 + 9 - x^4 + 4x^2 - 4 + 4 \cdot (x^2 + 6x + 9) =
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \({101}^2 = {(100 + 1)}^2 = 100^2 + 2 \cdot 100 \cdot 1 + 1^2 = 10.000 + 200 + 1 = \mathbf{10.201}\) % a)

  \item \({103}^2 = {(100 + 3)}^2 = 100^2 + 2 \cdot 100 \cdot 3 + 3^2 = 10.000 + 600 + 9 = \mathbf{10.609}\) % b)

  \item \({1.008}^2 = {(1.000 + 8)}^2 = 1.000^2 + 2 \cdot 1.000 \cdot 8 + 8^2 = 1.000.000 + 16.000 + 64 = \mathbf{1.016.064}\) % c)

  \item \({205}^2 = {(200 + 5)}^2 = 200^2 + 2 \cdot 200 \cdot 5 + 5^2 = 40.000 + 2.000 + 25 = \mathbf{42.025}\) % d)

  \item \({99}^2 = {(100 - 1)}^2 = 100^2 - 2 \cdot 100 \cdot 1 + 1^2 = 10.000 - 200 + 1 = \mathbf{9.801}\) % e)

  \item \({94}^2 = {(100 - 6)}^2 = 100^2 - 2 \cdot 100 \cdot 6 + 6^2 = 10.000 - 1.200 + 36 = \mathbf{8.836}\) % f)

  \item \({993}^2 = {(1000 - 7)}^2 = 1000^2 - 2 \cdot 1000 \cdot 7 + 7^2 = 1.000.000 - 14.000 + 49 = \mathbf{986.049}\) % g)

  \item \({195}^2 = {(200 - 5)}^2 = 200^2 - 2 \cdot 200 \cdot 5 + 5^2 = 40.000 - 2.000 + 25 = \mathbf{38.025}\) % h)
...
\begin{enumerate}[label=\alph*)]
  ...
  \item \(\cfrac{{(x - y)}^2}{x^2 - y^2} = \cfrac{(x - y) \cdot (x - y)}{(x + y) \cdot (x - y)} = \mathbf{\cfrac{x - y}{x + y}}\) % f)
